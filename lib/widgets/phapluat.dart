...
class PhapLuatWidget extends StatefulWidget {
  const PhapLuatWidget({super.key});

  @override
  State<PhapLuatWidget> createState() => _PhapLuatWidget();
}

class _PhapLuatWidget extends State<PhapLuatWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FutureBuilder<List<dynamic>>(
        future: dataService.getLawCategories(),
