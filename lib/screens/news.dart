          ...
          Expanded(
            child: TabBarView(
              children: [
                ...
                Center(child: Text('Nội dung độc và lạ')),
                Center(child: Text('Nội dung tình yêu')),
                Center(child: Text('Nội dung giải trí')),
                Center(child: Text('Nội dung thế giới')),
                Center(child: Text('Nội dung pháp luật')),
              ],
            ),
          ),
        ],
